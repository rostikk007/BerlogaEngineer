...
public class Shop : MonoBehaviour
{
    ...
    {
        _previewedItem = item;
        _selectedImage.sprite = item.Image.sprite;
        //_skinPlacement.InstantiateModel(_previewedItem.Model);
        //_current = Instantiate(_previewedItem.Model);
        //Transform[] childrens = _previewedItem.GetComponentsInChildren<Transform>();
        //foreach (var child in childrens)
        //{
        //print(child);
        //    _selectedImage.sprite = childrens[0].Image;
        //}
        //_selectedImage.sprite = _previewedItem.Image.sprite;
        //_skinPlacement.InstantiateModel(_previewedItem.Model);
